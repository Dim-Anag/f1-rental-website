...
const CarDetails = () => {
  ...
  useEffect(() => {
    setCar(cars.find(car => car._id === id))  //dummyCarData
  }, [cars, id])
        ...
        <img src={assets.arrow_icon} alt="" className='rotate-180 opacity-65' />  
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
            ...
            className='lg:col-span-2'>
              ...
              src={car.image} alt='' className='w-full h-auto md:max-h-100 object-cover rounded-xl mb-6 shadown-md' />
              <motion.div 
                initial={{opacity:0 }}
                animate={{opacity:1}}
              ...
              className='space-y-6'>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                  {[
                    {icon: assets.trophy_icon, text: `${car.race_wins} Race Wins`},
                    {icon: assets.engine_icon, text: `Engine: ${car.engine_type} `},
                    {icon: assets.helmet_icon, text: `${car.driver} `},
            ...
            onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'> 
              ...
              <p className='flex items-center justify-between text-2xl
               text-gray-800 font-semibold'>{currency}{car.pricePerDay}  <span className='text-base text-gray-400 font-normal'>per day</span></p>
              <hr className='border-borderColor my-6'/>
