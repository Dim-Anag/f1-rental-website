  ...
  return (
    ...
    >
      <Link to="/" className="flex items-center gap-3">
        <motion.img whileHover={{scale: 1.5}} src={assets.logo} alt="logo" className="h-12 " />
        <motion.span whileHover={{scale: 1.2}} className="text-xl font-semibold text-gray-800">Rent F1 Cars</motion.span>
        </Link>
