  ...
  return (
    ...
    transition-all duration-500 cursor-pointer'>
      ...
      <div className='relative h-48 overflow-hidden'>
        ...
        <div className='absolute top-4 right-4 bg-black/80 backdrop-blur-sm text-white px-3 py-2 rounded-lg'>
        ...
        <div className='p-4 sm:p-5'>
            ...
            <div className='mt-4 grid grid-cols-2 gap-y-2 text-gray-600'>
                <div className='flex items-center text-sm text-muted-foreground'>
                    <img src={assets.trophy_icon} alt="" className='h-4 mr-2' />
                    <span>{car.race_wins} Race Wins</span>
                </div>
                <div className='flex items-center text-sm text-muted-foreground'>
                    <img src={assets.engine_icon} alt="" className='h-4 mr-2' />
                    <span>{car.engine_type}</span>
                </div>
                <div className='flex items-center text-sm text-muted-foreground'>
                    <img src={assets.helmet_icon} alt="" className='h-4 mr-2' />
