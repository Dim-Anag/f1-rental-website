...
import { assets,  ownerMenuLinks } from '../../assets/assets'   //dummyUserData,
...
const Sidebar = () => {
    ...
    const {user, axios, fetchUser} = useAppContext()    //const user = dummyUserData;
  ...
  return (
    ...
    max-w-13 md md:max-w-60 w-full border-r border-borderColor text-sm'>
        <div className='group relative'>
            <label htmlFor="image">
                <img src={image ? URL.createObjectURL(image) : user?.image || 
                    "https://ik.imagekit.io/dimanag/tr:w-400:q-auto:f-webp/users/zak_brown_eER210zYO.webp"} className="w-300" alt="" />
